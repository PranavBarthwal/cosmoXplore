...
window.addEventListener("load", (e) => {
  ...
  document.getElementById("api_loader_apod").style.display='flex'; // starting loading animation before api call
  ...
  .then((response) => {
    ...
    document.getElementById("apod_info_container").style.display='none';
...
function displayRover(){
  ...
  document.getElementById("api_loader_rover").style.display = 'block';
