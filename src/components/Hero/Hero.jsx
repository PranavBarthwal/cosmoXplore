...
function Hero() {
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          heroElement.classList.add('reveal');
          imageElement.classList.add('reveal-left');
          contentElement.classList.add('reveal-left');
        }
      });
    }, observerOptions);
  ...
  return (
    <div className="container col-xxl-9 px-3 py-5 override-display" ref={he}>
      <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div className="col-10 col-sm-8 col-lg-6" ref={image}>
          <img src={logo} className="d-block mx-lg-auto img-fluid hero_img" alt="Bootstrap Themes" width="700" height="500" loading="lazy" />
        </div>
        <div className="col-lg-6" ref={content}>
