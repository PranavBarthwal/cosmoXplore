...
function Apod() {
  ...
  return (
    ...
    <>
      <h1 align="center" className={Styles['section_title'] + " " + Styles['section_title_mobile']} id="apod" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-offset="170" data-aos-easing="ease-in-out">Astronomy Picture of The Day</h1 >

      <div className="container my-5 overflow-x-hidden">

        <div className="row mx-1 p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg" id="class_removal" data-aos="zoom-in" data-aos-duration="1000" data-aos-offset="170" data-aos-easing="ease-in-out">
