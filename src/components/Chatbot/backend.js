...
const greetings_responses = {
    ...
    "want to explore": "Yes, let's explore together!",
    ...
    "gotta go": "Alright, see you next time!",
    "until next time": "Until next time! Have a good one!",
    "later": "Later! Remember, I'm always here to help!",
